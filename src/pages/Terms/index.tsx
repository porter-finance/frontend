...
export const Terms: React.FC = () => {
  return (
    <>
      <PageTitleStyled>Porter Finance Terms &amp; Conditions</PageTitleStyled>
      ...
      <OrderedListMultiNumber>
        <LiMultiNumber>
          ...
          <OrderedListMultiNumber>
            <LiMultiNumber>
              Porter Finance is operated by PorterDAO <strong>(&quot;We&quot;)</strong>. We are an
              Ethereum based organisation managed by community members. To contact us, please write
              to us via the PorterDAO subcategory of{' '}
              <a href="https://forum.gnosis.io" rel="noreferrer" target="_blank">
                forum.gnosis.io
              </a>
              .
            ...
            <LiMultiNumber>
              We use open source products and developer materials from Porter Limited and affiliated
              persons and entities
              <strong>(&quot;Affiliates&quot;)</strong> as well as other third parties to provide a
              Platform to the Porter Finance Protocol. The provision of the Platform and the
        ...
        <LiMultiNumber>
          <LiTitleNoMarginTop>
            WE PROVIDE A PLATFORM TO INTERACTING WITH THE PORTER FINANCE PROTOCOL
          </LiTitleNoMarginTop>
          <OrderedListMultiNumber>
            <LiMultiNumber>
              We provide a graphical user interface (the <strong>&quot;Platform&quot;</strong>) to
              facilitate you interacting with the Porter Finance protocol for ERC 20 tokens (the{' '}
              <strong>&quot;Protocol&quot;</strong>).
            </LiMultiNumber>
            <LiMultiNumber>
              The Protocol was developed by Porter Limited and is governed by a series of smart
          ...
          <OrderedListMultiNumber>
            ...
            <LiMultiNumber>
              ...
              <OrderedListMultiNumber>
                ...
                <LiMultiNumber>
                  Depending on whether you interact with Porter Finance on Ethereum Mainnet or
          ...
          <OrderedListMultiNumber>
            <LiMultiNumber>
              <span>
                ...
                us amicably by referring the matter first to PorterDAO subcategory of the
