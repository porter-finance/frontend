  ...
  return (
    <Wrapper>
      <Inner>
        <InfoIcon />
        <Text>
          Porter Finance is a permissionless platform. Anyone can start auctions, and no auction is
          an endorsement for the token from Porter. Use the platform at your own risk, and make sure
