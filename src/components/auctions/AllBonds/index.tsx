...
const AllBonds = (props: Props) => {
  ...
  const noBonds = tableData.length === 0
  const noBondsFound = page.length === 0
  const noData = noBonds || noBondsFound
      ...
      <TableControls>
        <SearchWrapper>
          ...
          <SearchInput
            ...
            placeholder={`Search by bond Id, selling token, buying token, date…`}
